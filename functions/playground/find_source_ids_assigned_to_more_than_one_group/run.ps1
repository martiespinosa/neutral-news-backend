...
$scriptPath = Join-Path $PSScriptRoot "find_source_ids_assigned_to_more_than_one_group.py"
...
Write-Host "▶️ Running script to find source IDs assigned to multiple groups..."
python $scriptPath

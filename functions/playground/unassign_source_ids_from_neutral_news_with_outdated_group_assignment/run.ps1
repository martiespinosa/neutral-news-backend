...
$scriptPath = Join-Path $PSScriptRoot "unassign_source_ids_from_neutral_news_with_outdated_group_assignment.py"
...
Write-Host "▶️ Running script to fix mismatched source IDs in neutral news..."
python $scriptPath

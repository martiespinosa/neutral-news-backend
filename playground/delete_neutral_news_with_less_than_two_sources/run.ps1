...
$scriptPath = Join-Path $PSScriptRoot "delete_neutral_news_with_less_than_two_sources.py"
...
Write-Host "▶️ Running delete script to remove neutral_news with fewer than 2 sources..."
python $scriptPath
